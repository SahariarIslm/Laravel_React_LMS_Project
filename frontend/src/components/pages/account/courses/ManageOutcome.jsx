...
const ManageOutcome = () => {
    ...
    const [outcomeData, setShowOutcomeData] = useState([]);
                ...
                <div className='card-body p-4'>
                    ...
                    </form>
                    {
                        outcomes && outcomes.map(outcome => {
                            return (
                                <div key={`outcome-${outcome.id}`} className='card shadow-lg mb-2'>
